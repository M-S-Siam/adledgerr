      ...
      case 'Meta':
        return (
          <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
            <path d="M6.915 4.03c-2.454 0-4.545 1.547-5.59 3.8C.422 9.774 0 11.83 0 13.79c0 3.81 2.37 6.18 5.75 6.18 2.37 0 4.14-1.39 5.37-3.23 1.23 1.84 3 3.23 5.37 3.23 3.38 0 5.75-2.37 5.75-6.18 0-1.96-.42-4.016-1.325-5.96-1.045-2.253-3.136-3.8-5.59-3.8-2.37 0-4.14 1.39-5.37 3.23-1.23-1.84-3-3.23-5.37-3.23Zm-.28 2.66c1.55 0 2.87 1.09 3.75 2.76-1.14 2.12-2.39 4.31-3.69 5.86-1.09 1.31-2.09 1.94-2.92 1.94-1.88 0-3.04-1.42-3.04-3.82 0-1.43.3-2.97.94-4.38.68-1.5 2.22-2.36 4.96-2.36Zm10.73 0c2.74 0 4.28.86 4.96 2.36.64 1.41.94 2.95.94 4.38 0 2.4-1.16 3.82-3.04 3.82-.83 0-1.83-.63-2.92-1.94-1.3-1.55-2.55-3.74-3.69-5.86.88-1.67 2.2-2.76 3.75-2.76Z" fill="#0668E1"/>
          </svg>
        );
      case 'GoogleAds':
        return (
          <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
            <path d="M3.868 15.657l6.812-11.8a3.197 3.197 0 014.368-1.171l.004.002a3.197 3.197 0 011.17 4.368l-6.812 11.8a3.197 3.197 0 01-4.368 1.172l-.004-.003a3.197 3.197 0 01-1.17-4.368z" fill="#FBBC04"/>
            <path d="M16.222 7.056l4.088 7.08a3.197 3.197 0 01-1.17 4.368l-.004.003a3.197 3.197 0 01-4.368-1.172l-4.088-7.08a3.197 3.197 0 011.17-4.368l.004-.002a3.197 3.197 0 014.368 1.171z" fill="#4285F4"/>
            <circle cx="6.455" cy="18.045" r="3.197" fill="#34A853"/>
          </svg>
        );
      case 'TikTok':
        return (
